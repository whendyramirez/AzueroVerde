...
<div class="container">
  <div class="row">
    <div class="col-sm-3">
          <nav class="navbar bg-light">
            <ul class="navbar-nav  nav-justified">
                <li class="nav-item">
                  <a class="nav-link " href="#">Conoce Observatorio</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link-active1" href="#">Programas</a>
                </li>
                <li class="nav-item">
                  <a target="top" class="nav-link" href="#">Marco Legal</a>
                </li>
                <li class="nav-item">
    ...
    <div class="col-sm-9">
      <h3 style="color:#002662">Conoce el Módulo Observatorio</h3>
      <table>
        <tr>
            <td style="background-color: #002662; text-align: center">
                <img src="imagen/ME-blanco.png" alt="Ministerio De Ambiente" style="width:110px;height:120px;">
            </td>
            <td style="background-color: #002662; text-align: center">
                <img src="imagen/VRC.png" alt="Ministerio De Ambiente" style="width:110px;height:100px;">
            </td>
        </tr>
        <tr>
            <td>
                <p>Monitoreo y Evaluación (M&E)</p>
            </td>
            <td>
                <p>Vulnerabilidad y Riesgo Climatico</p>
            </td>
        </tr>
      </table>
  <!-- The slideshow -->
